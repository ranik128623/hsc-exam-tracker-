...
export function Navbar({ onToggleMobileMenu, mobileMenuOpen }: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-colors pt-safe">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-16 py-2 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-2.5 min-w-[44px] min-h-[44px] rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 lg:hidden flex items-center justify-center cursor-pointer active:scale-95"
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-emerald-600 to-teal-500 flex items-center justify-center text-white shadow-sm font-bold text-lg shrink-0">
              🎯
            </div>
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline-flex items-center px-2 py-0.5 text-xs font-semibold rounded-full border bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700">
                  UTC+6 BST
                </span>
              </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <button
            ...
            className="p-2 min-w-[40px] min-h-[40px] rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-emerald-600 transition-colors flex items-center justify-center cursor-pointer active:scale-95"
          ...
          <button
            ...
            className={`px-2.5 py-1.5 min-h-[40px] rounded-lg text-xs font-semibold flex items-center gap-1.5 border transition-all cursor-pointer active:scale-95 ${
          ...
          {/* Streak indicator */}
          {currentStreak > 0 && (
            <div className="hidden lg:flex items-center gap-1 px-2.5 py-1.5 min-h-[40px] rounded-lg bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 text-xs font-bold text-amber-600 dark:text-amber-400">
          ...
          <button
            ...
            className="px-3 py-1.5 min-h-[40px] rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs sm:text-sm font-semibold flex items-center gap-1.5 shadow-sm transition-transform active:scale-95 cursor-pointer"
          >
          ...
          <button
            ...
            className="p-2 min-w-[40px] min-h-[40px] rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors flex items-center justify-center cursor-pointer active:scale-95"
            title={
